...
export default function SignupPage() {
    ...
    const validateForm = () => {
        ...
        if (!formData.username) {
            ...
            newErrors.username = '※使用できる文字は、半角英数字とアンダーバー、ハイフンのみです'
            isValid = false
        }
        ...
        if (!formData.password) {
            ...
            newErrors.password = '※パスワードは8文字以上で、英字と数字を含む必要があります'
            isValid = false
        }
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.username && <p className="text-yellow-300 text-sm mt-1">{errors.username}</p>}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.password && <p className="text-yellow-300 text-sm mt-1">{errors.password}</p>}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.confirmPassword && <p className="text-yellow-300 text-sm mt-1">{errors.confirmPassword}</p>}
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            {errors.name && <p className="text-yellow-300 text-sm mt-1">{errors.name}</p>}
                        </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                        <Checkbox
                            ...
                            onCheckedChange={(checked) => setFormData({ ...formData, agreeTerm: !!checked })}

                            />
                        <Label htmlFor="terms" className="text-sm text-white">
                        Gym Diaryの<Link to="/terms" className="underline">利用規約</Link> を確認し、これに同意します。
                        </Label>
                        <br />
                    </div>
                    {errors.agreeTerm && <p className="block text-yellow-300 text-sm mt-1">{errors.agreeTerm}</p>}

                    <LoadingButton loading={submitting} type="submit" className="w-full bg-primary hover:bg-primary/90">
                        登録
                    </LoadingButton>
